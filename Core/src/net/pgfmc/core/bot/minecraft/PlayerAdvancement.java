package net.pgfmc.core.bot.minecraft;
...
public class PlayerAdvancement {
	...
	public void checkPacketForAdvancement() {
		...
		ProtocolLibrary.getProtocolManager().addPacketListener(new PacketAdapter(CoreMain.plugin, ListenerPriority.NORMAL, PacketType.Play.Server.ADVANCEMENTS) {
			@Override
